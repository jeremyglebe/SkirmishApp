...
export const routes: Routes = [
  ...
  // Tabs page must specify routes to each of the child pages
  {
    ...
    children: [
      ...
      // The units tab lists all the units and allows users to enter creation and view pages
      {
        path: 'units',
        loadComponent: () =>
          import('./units-list/units-list.page').then((m) => m.UnitsListPage),
      },
  ...
  // The unit creation page is where users design new units
  {
    path: 'unit-editor',
    loadComponent: () =>
      import('./unit-editor/unit-editor.page').then((m) => m.UnitEditorPage),
  },
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './pages/create-unit/create-unit-details/create-unit-details.page'
      ).then((m) => m.CreateUnitDetailsPage),
  },
  {
    path: 'home',
    loadComponent: () =>
